...
GamePlay.prototype = {
    ...
    create: function () {
        ...
        for (var i = 0; i <= 5; i++) {
            ...
            backGroundArray[i].inputEnabled = true;
            backGroundArray[i].events.onInputDown.add(this.CanonClick, this);
        ...
        cannonBody = Utils.SpriteSettingsControl(cannonBody, 340, 1164, 'cannon_body', "true", "true", 0.5, 0.5, 0.5, 0.5, "true");
